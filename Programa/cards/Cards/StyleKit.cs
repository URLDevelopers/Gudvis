...
namespace Cards
{
	public static class StyleKit
	{
		...
		public static Color BarBackgroundColor = Color.FromHex ("00C853");
		public static Color CardFooterBackgroundColor = Color.FromHex ("F6F6F6");

		public static class Status
		{
			public static Color CompletedColor = Color.FromHex ("00C853");
		...
		public class Icons
		{
			...
			public static FileImageSource Cog = new FileImageSource () { File = "ic_done_black_24dp.png" };
